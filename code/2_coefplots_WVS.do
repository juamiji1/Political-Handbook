...
foreach var of global trust_inv {
	...
	eststo x: reghdfe `var' c.ln_gdp#i.wave, abs(i.year i.regionfe i.iso) nocons keepsingleton vce(cl iso)
	coefplot x, vert coeflabel(1.wave#c.ln_gdp = "1981-1984" 2.wave#c.ln_gdp ="1989-1993" 3.wave#c.ln_gdp ="1994-1998" 4.wave#c.ln_gdp ="1999-2004" 5.wave#c.ln_gdp ="2005-2009" 6.wave#c.ln_gdp ="2010-2014" 7.wave#c.ln_gdp ="2017-2022") yline(0, lc(gray)) xtitle("Wave", size(medium)) ytitle("`varlabel'", size(medsmall)) baselevels
	gr export "${plots}/coefplot_`var'.pdf", as(pdf) replace
}
...
foreach var of global percep_inv {
	...
	eststo x: reghdfe `var' c.ln_gdp#i.wave, abs(i.year i.regionfe i.iso) nocons keepsingleton vce(cl iso)
	coefplot x, vert coeflabel(1.wave#c.ln_gdp = "1981-1984" 2.wave#c.ln_gdp ="1989-1993" 3.wave#c.ln_gdp ="1994-1998" 4.wave#c.ln_gdp ="1999-2004" 5.wave#c.ln_gdp ="2005-2009" 6.wave#c.ln_gdp ="2010-2014" 7.wave#c.ln_gdp ="2017-2022") yline(0, lc(gray)) xtitle("Wave") ytitle("`varlabel'", size(medsmall)) baselevels
	gr export "${plots}/coefplot_`var'.pdf", as(pdf) replace
}
